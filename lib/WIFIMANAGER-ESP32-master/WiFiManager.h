...
const char HTTP_PORTAL_OPTIONS[] PROGMEM  = "<form action=\"/wifi\" method=\"get\"><button>Configurar WiFi</button></form><br/><form action=\"/0wifi\" method=\"get\"><button>Configurar WiFi (No Scan)</button></form><br/>";
